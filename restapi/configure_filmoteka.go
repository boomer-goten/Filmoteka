...
//go:generate swagger generate server --target ../../src --name Filmoteka --spec ../swagger.yaml --principal models.Principal

type pathArg struct {
	Path string `long:"config" description:"Path to config file" default:"./config/config.yaml"`
}
